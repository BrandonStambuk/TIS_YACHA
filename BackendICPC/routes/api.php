...
use App\Http\Controllers\Api\TipoCompetenciaDinamicaController;
...
Route::controller(EventoDinamicoController::class)->group(function (){
  ...
  Route::get('/eventosDinamicosComp', 'indexComp');
...
Route::controller(TipoCompetenciaDinamicaController::class)->group(function (){
  Route::get('/tipoCompetenciasDinamicas', 'index');
  Route::post('/crearTipoCompetenciaDinamica', 'store');
  Route::delete('/eliminarTipoCompetenciaDinamica/{id}', 'destroy');
  Route::put('/actualizarTipoCompetenciaDinamica/{id}', 'update');
});
