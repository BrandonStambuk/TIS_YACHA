              ...
              <div className="card-body table-responsive tabla-contenedor">
                <table>
                  <thead className='text-white'>
                    <tr>
                      {/* solo quedandose con pocos elementos de la tabla */ }
                      <th className="centrado">Nombre</th>
                      <th className="centrado">Tipo</th>
                      <th className="centrado">Fecha de inicio</th>
                      {/* En publicado falta poner si o no */ }
                      <th className="centrado">Publicado</th>
