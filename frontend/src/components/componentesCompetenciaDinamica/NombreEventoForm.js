...
const NombreEventoForm = ({ nombreEvento, lugarEvento, cantidadParticiapantesEvento, onNombreEventoChange, 
  onLugarEventoChange, onCantidadParticipantesChange,onGuardarEvento, contador,onContadorChange }) => {
